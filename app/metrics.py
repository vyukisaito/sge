...
def get_products_metrics():
    ...
    # com se esse código do total cost fosse esse grandao
...
def get_sales_metrics():
    ...
    total_products_sold = Outflow.objects.aggregate(  # vai somando o campo quantidade
        total_products_sold=Sum('quantity')
    )['total_products_sold'] or 0  # caso seja nulo retorna 0
